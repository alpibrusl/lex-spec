...
fn balance_invariant() -> sp.Spec {
  { name: "transfer_keeps_total", quantifiers: [QInt("a_before"), QInt("b_before"), QInt("amount")], predicate: EBinop({ op: "==", lhs: EBinop({ op: "+", lhs: EVar("a_before"), rhs: EVar("b_before") }), rhs: EBinop({ op: "+", lhs: EBinop({ op: "-", lhs: EVar("a_before"), rhs: EVar("amount") }), rhs: EBinop({ op: "+", lhs: EVar("b_before"), rhs: EVar("amount") }) }) }) }
}
